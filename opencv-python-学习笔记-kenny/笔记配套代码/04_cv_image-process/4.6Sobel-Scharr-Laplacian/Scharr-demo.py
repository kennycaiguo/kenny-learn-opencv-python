...
img = cv2.imread('../mydata/ml.png',0)
...
plt.subplot(2,2,3),plt.imshow(scharr_x,cmap = 'gray'),plt.title("Scharr axis x"),plt.xticks([]), plt.yticks([])
plt.subplot(2,2,4),plt.imshow(scharr_y,cmap = 'gray'),plt.title("Scharr axis y"),plt.xticks([]), plt.yticks([])
plt.show()
